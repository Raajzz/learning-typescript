...
const merge = <T extends object, U extends object | number>(
  obj1: T,
  obj2: U
) => {
...
const mergedObject = merge(
  { name: "John" },
  19 // produces an error as we constrained our U type to object, will work if we extend to object | number
);
